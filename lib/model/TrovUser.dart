...
class TrovUser extends DocItem {
  ...
  TrovUser({this.email, this.friends, this.shareLocation});
  ...
  Map toJson() {
    return {
      DocItem.FLD_ID: id,
      DocItem.FLD_NAME: name,
      FLD_EMAIL: email,
      FLD_SHARE_LOCATION: shareLocation,
      friends: FLD_FRIENDS
    };
  }
  ...
  fromMap(Map<String, Object> data) {
    ...
    if ((data[FLD_FRIENDS] != null) &&
        ((data[FLD_FRIENDS] as List).length > 0)) {
